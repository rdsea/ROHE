...
class NodeRuntimeHandler(BaseModel):
    features: Optional[NodeRuntimeHandlerFeatures] = Field(
        None, description="Supported features."
    )
    name: Optional[str] = Field(
...
class ContainerStatus(BaseModel):
    ...
    volume_mounts: Optional[List[VolumeMountStatus]] = Field(
        None, alias="volumeMounts", description="Status of volume mounts."
    )
...
class PodStatus(BaseModel):
    ...
    resource_claim_statuses: Optional[List[PodResourceClaimStatus]] = Field(
        None, alias="resourceClaimStatuses", description="Status of resource claims."
    )
