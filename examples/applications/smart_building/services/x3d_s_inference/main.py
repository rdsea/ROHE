"""X3D Small inference service for activity recognition.

Balanced video model with moderate accuracy and speed.
...
BASE_CONFIDENCE_RANGE = (0.45, 0.78)
SIMULATED_LATENCY_RANGE_MS = (30, 70)
...
async def predict(
    ...
    """Run X3D-S inference on uploaded video frame."""
