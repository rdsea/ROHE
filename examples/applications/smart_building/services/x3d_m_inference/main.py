"""X3D Medium inference service for activity recognition.

Best accuracy video model, slower inference time.
...
# Accuracy profile: highest accuracy, slowest inference
BASE_CONFIDENCE_RANGE = (0.55, 0.88)
SIMULATED_LATENCY_RANGE_MS = (60, 150)
...
async def predict(
    ...
    """Run X3D-M inference on uploaded video frame."""
