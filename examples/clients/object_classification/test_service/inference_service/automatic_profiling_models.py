...
if __name__ == '__main__':
    ...
    # for collector
    parser.add_argument('--interval', help='specify period of time to collect data for each model', type=int, default= 60)
    ...
    collector_job = CollectorJob(interval=args.interval, config=collector_conf, 
