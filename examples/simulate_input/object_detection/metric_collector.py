...
if __name__ == '__main__':
    ...
    client_qoa_1.init_report(client_conf["instanceID"]+"_1", client_conf["method"], client_conf["stageID"]+"_1")
    client_qoa_2 = Qoa_Client(client_config,connector_conf)
    client_qoa_2.init_report(client_conf["instanceID"]+"_2", client_conf["method"], client_conf["stageID"]+"_2")
    client_qoa_3 = Qoa_Client(client_config,connector_conf)
    client_qoa_3.init_report(client_conf["instanceID"]+"_3", client_conf["method"], client_conf["stageID"]+"_3")
    client_qoa_4 = Qoa_Client(client_config,connector_conf)
    client_qoa_4.init_report(client_conf["instanceID"]+"_4", client_conf["method"], client_conf["stageID"]+"_4")

    feedback_conf = client_config.copy()
    feedback_conf["role"] = "customer"
    client_qoa_5 = Qoa_Client(feedback_conf,connector_conf)
    client_qoa_5.init_report(client_conf["instanceID"]+"_5", client_conf["method"], client_conf["stageID"]+"_5")
    ...
    def sender(num_thread):
        ...
        while (time.time() - start_time < 60000):
            try:
                ...
                client_qoa_2.timer()
                client_qoa_2.ex_observe_data_quality("object_height", random.randint(1, 100))
                prediction_2 = client_qoa_2.ex_observe_confidence(random.randint(0, 1),random.randint(1,100)/100)
                report_2 = client_qoa_2.report_external(client_qoa_2.timer())


                client_qoa_3.timer()
                client_qoa_3.ex_observe_data_quality("object_height", random.randint(1, 100))
                prediction_3 = client_qoa_3.ex_observe_confidence(random.randint(0, 1),random.randint(1,100)/100)
                ...
                client_qoa_4.ex_observe_data_quality("object_height", random.randint(1, 100))
                prediction_4 = client_qoa_4.ex_observe_confidence(random.randint(0, 1),random.randint(1,100)/100, [prediction_1,prediction_2,prediction_3])
