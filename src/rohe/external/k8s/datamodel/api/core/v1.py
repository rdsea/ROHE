...
class ClaimSource(BaseModel):
    resource_claim_name: Optional[str] = Field(
        default=None,
        alias="resourceClaimName",
        description="ResourceClaimName is the name of a ResourceClaim object in the same namespace as this pod.",
    )
    resource_claim_template_name: Optional[str] = Field(
        default=None,
...
class HostIP(BaseModel):
    ip: Optional[str] = Field(
        default=None, description="IP is the IP address assigned to the host"
    )
...
class ModifyVolumeStatus(BaseModel):
    ...
    target_volume_attributes_class_name: Optional[str] = Field(
        default=None,
...
class NodeRuntimeHandlerFeatures(BaseModel):
    recursive_read_only_mounts: Optional[bool] = Field(
        default=None,
...
class PodIP(BaseModel):
    ip: Optional[str] = Field(
        default=None, description="IP is the IP address assigned to the pod"
    )
...
class PodResourceClaim(BaseModel):
    ...
    source: Optional[ClaimSource] = Field(
        default={}, description="Source describes where to find the ResourceClaim."
    )
...
class VolumeMount(BaseModel):
    ...
    recursive_read_only: Optional[str] = Field(
        default=None,
...
class CSIPersistentVolumeSource(BaseModel):
    ...
    node_expand_secret_ref: Optional[SecretReference] = Field(
        default=None,
...
class ContainerStateTerminated(BaseModel):
    ...
    finished_at: Optional[AwareDatetime] = Field(
        default=None,
        alias="finishedAt",
...
class ContainerUser(BaseModel):
    linux: Optional[LinuxContainerUser] = Field(
        default=None,
...
class EmptyDirVolumeSource(BaseModel):
    ...
    size_limit: Optional[Union[str, float]] = Field(
        default=None,
        alias="sizeLimit",
...
class EventSeries(BaseModel):
    ...
    last_observed_time: Optional[AwareDatetime] = Field(
        default=None,
...
class LimitRangeItem(BaseModel):
    default: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        description="Default resource requirement limit value by resource name if resource limit is omitted.",
    )
    default_request: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        alias="defaultRequest",
        description="DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.",
    )
    max: Optional[Dict[str, Union[str, float]]] = Field(
        default=None, description="Max usage constraints on this kind by resource name."
    )
    max_limit_request_ratio: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        alias="maxLimitRequestRatio",
        description="MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value; this represents the max burst for the named resource.",
    )
    min: Optional[Dict[str, Union[str, float]]] = Field(
...
class NamespaceCondition(BaseModel):
    last_transition_time: Optional[AwareDatetime] = Field(
        default=None,
...
class NodeRuntimeHandler(BaseModel):
    features: Optional[NodeRuntimeHandlerFeatures] = Field(
...
class NodeStatus(BaseModel):
    ...
    allocatable: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
    ...
    runtime_handlers: Optional[List[NodeRuntimeHandler]] = Field(
        default=None,
...
class PersistentVolumeClaimCondition(BaseModel):
    last_probe_time: Optional[AwareDatetime] = Field(
        default=None,
        alias="lastProbeTime",
...
class PersistentVolumeClaimStatus(BaseModel):
    ...
    allocated_resource_statuses: Optional[Dict[str, str]] = Field(
        default=None,
    ...
    allocated_resources: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
    ...
    current_volume_attributes_class_name: Optional[str] = Field(
        default=None,
    ...
    modify_volume_status: Optional[ModifyVolumeStatus] = Field(
        default=None,
...
class PersistentVolumeStatus(BaseModel):
    last_phase_transition_time: Optional[AwareDatetime] = Field(
        default=None,
...
class PodSecurityContext(BaseModel):
    app_armor_profile: Optional[AppArmorProfile] = Field(
        default=None,
    ...
    supplemental_groups_policy: Optional[str] = Field(
        default=None,
...
class ResourceQuotaStatus(BaseModel):
    hard: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
        description="Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/",
    )
    used: Optional[Dict[str, Union[str, float]]] = Field(
        default=None,
...
class ServiceSpec(BaseModel):
    ...
    traffic_distribution: Optional[str] = Field(
        default=None,
...
class Taint(BaseModel):
    ...
    time_added: Optional[AwareDatetime] = Field(
        default=None,
        alias="timeAdded",
...
class Event(BaseModel):
    ...
    event_time: Optional[AwareDatetime] = Field(
        default=None,
        alias="eventTime",
        description="Time when this Event was first observed.",
    )
    first_timestamp: Optional[AwareDatetime] = Field(
        default=None,
    ...
    last_timestamp: Optional[AwareDatetime] = Field(
        default=None,
        alias="lastTimestamp",
...
class PersistentVolumeClaimSpec(BaseModel):
    ...
    data_source_ref: Optional[TypedObjectReference] = Field(
        default=None,
        alias="dataSourceRef",
    ...
    volume_attributes_class_name: Optional[str] = Field(
        default=None,
...
class PodAffinityTerm(BaseModel):
    ...
    match_label_keys: Optional[List[str]] = Field(
        default=None,
    ...
    mismatch_label_keys: Optional[List[str]] = Field(
        default=None,
...
class PodStatus(BaseModel):
    ...
    resource_claim_statuses: Optional[List[PodResourceClaimStatus]] = Field(
        default=None,
...
class TopologySpreadConstraint(BaseModel):
    ...
    node_affinity_policy: Optional[str] = Field(
        default=None,
    ...
    node_taints_policy: Optional[str] = Field(
        default=None,
...
class VolumeProjection(BaseModel):
    cluster_trust_bundle: Optional[ClusterTrustBundleProjection] = Field(
        default=None,
...
class Container(BaseModel):
    ...
    resize_policy: Optional[List[ContainerResizePolicy]] = Field(
        default=None,
        alias="resizePolicy",
...
class PodSpec(BaseModel):
    ...
    host_users: Optional[bool] = Field(
        default=None,
        alias="hostUsers",
    ...
    resource_claims: Optional[List[PodResourceClaim]] = Field(
        default=None,
    ...
    scheduling_gates: Optional[List[PodSchedulingGate]] = Field(
        default=None,
