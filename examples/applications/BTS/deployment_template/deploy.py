...
def run():
    ...
    service_patched = api.patch(body=service_config, name=service.metadata.name, namespace="default")
    ...
    service_deleted = api.delete(name=service.metadata.name, body={}, namespace="default")
