...
class EnsembleOptimization(ABC, object):
    ...
    """
    def __init__(self, objective_func_name: str, model_list: list, infrastructure_list: list):
        super().__init__()
    ...
    def set_optimization_algorithm(self, algo_name:str):
        self.optimization_algorithm = rUtils.get_function_from_module(algorithm, algo_name)
