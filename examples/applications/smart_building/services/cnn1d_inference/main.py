"""1D CNN inference service for activity recognition.

Time-series model using 1D convolutional neural network.
...
# Accuracy profile: moderate accuracy, moderate speed
BASE_CONFIDENCE_RANGE = (0.42, 0.76)
SIMULATED_LATENCY_RANGE_MS = (8, 30)
...
async def predict(request: TimeSeriesRequest) -> dict:
    """Run 1D CNN inference on time-series sensor data."""
