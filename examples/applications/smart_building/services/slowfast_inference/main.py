"""SlowFast R50 inference service for activity recognition.

Alternative video architecture using dual-pathway (slow + fast) design.
...
# Accuracy profile: good accuracy, moderate-high latency
BASE_CONFIDENCE_RANGE = (0.50, 0.82)
SIMULATED_LATENCY_RANGE_MS = (50, 120)
...
async def predict(
    ...
    """Run SlowFast R50 inference on uploaded video frame."""
