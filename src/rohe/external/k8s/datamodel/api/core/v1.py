...
class Capabilities(BaseModel):
    add: list[str] | None = Field(default=None, description="Added capabilities")
    drop: list[str] | None = Field(default=None, description="Removed capabilities")
...
class NodeConfigStatus(BaseModel):
    active: NodeConfigSource | None = Field(
        default=None,
    ...
    assigned: NodeConfigSource | None = Field(
        default=None,
    ...
    last_known_good: NodeConfigSource | None = Field(
        default=None,
        alias="lastKnownGood",
...
class PodDNSConfigOption(BaseModel):
    name: str | None = Field(default=None, description="Required.")
    value: str | None = None
...
class EmptyDirVolumeSource(BaseModel):
    ...
    size_limit: str | float | None = Field(
        default=None,
        alias="sizeLimit",
...
class EventSeries(BaseModel):
    ...
    last_observed_time: AwareDatetime | None = Field(
        default=None,
...
class NodeCondition(BaseModel):
    last_heartbeat_time: AwareDatetime | None = Field(
        default=None,
...
class NodeStatus(BaseModel):
    ...
    allocatable: dict[str, str | float] | None = Field(
        default=None,
        description="Allocatable represents the resources of a node that are available for scheduling. Defaults to Capacity.",
    )
    capacity: dict[str, str | float] | None = Field(
        default=None,
...
class PersistentVolumeClaimCondition(BaseModel):
    last_probe_time: AwareDatetime | None = Field(
        default=None,
        alias="lastProbeTime",
...
class PersistentVolumeClaimStatus(BaseModel):
    ...
    allocated_resources: dict[str, str | float] | None = Field(
        default=None,
...
class PersistentVolumeStatus(BaseModel):
    last_phase_transition_time: AwareDatetime | None = Field(
        default=None,
...
class PodSecurityContext(BaseModel):
    app_armor_profile: AppArmorProfile | None = Field(
        default=None,
    ...
    sysctls: list[Sysctl] | None = Field(
        default=None,
        description="Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported sysctls (by the container runtime) might fail to launch. Note that this field cannot be set when spec.os.name is windows.",
    )
    windows_options: WindowsSecurityContextOptions | None = Field(
        default=None,
...
class ResourceQuotaStatus(BaseModel):
    hard: dict[str, str | float] | None = Field(
        default=None,
        description="Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/",
    )
    used: dict[str, str | float] | None = Field(
        default=None,
...
class ResourceRequirements(BaseModel):
    ...
    limits: dict[str, str | float] | None = Field(
        default=None,
        description="Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/",
    )
    requests: dict[str, str | float] | None = Field(
        default=None,
...
class ServiceSpec(BaseModel):
    ...
    ports: list[ServicePort] | None = Field(
        default=None,
...
class Taint(BaseModel):
    ...
    time_added: AwareDatetime | None = Field(
        default=None,
        alias="timeAdded",
...
class ClusterTrustBundleProjection(BaseModel):
    label_selector: v1.LabelSelector | None = Field(
        default=None,
        alias="labelSelector",
...
class Event(BaseModel):
    ...
    first_timestamp: AwareDatetime | None = Field(
        default=None,
...
class PersistentVolumeClaimSpec(BaseModel):
    ...
    data_source: TypedLocalObjectReference | None = Field(
        default=None,
        alias="dataSource",
    ...
    data_source_ref: TypedObjectReference | None = Field(
        default=None,
        alias="dataSourceRef",
    ...
    resources: VolumeResourceRequirements | None = Field(
        default={},
        description="resources represents the minimum resources the volume should have. If RecoverVolumeExpansionFailure feature is enabled users are allowed to specify resource requirements that are lower than previous value but must still be higher than capacity recorded in the status field of the claim. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources",
    )
    selector: v1.LabelSelector | None = Field(
        default=None,
...
class PodAffinityTerm(BaseModel):
    ...
    namespace_selector: v1.LabelSelector | None = Field(
        default=None,
...
class PodStatus(BaseModel):
    ...
    host_i_ps: list[HostIP] | None = Field(
        default=None,
        alias="hostIPs",
    ...
    pod_i_ps: list[PodIP] | None = Field(
        default=None,
        alias="podIPs",
...
class ServiceStatus(BaseModel):
    conditions: list[v1.Condition] | None = Field(
...
class EphemeralVolumeSource(BaseModel):
    volume_claim_template: PersistentVolumeClaimTemplate | None = Field(
        default=None,
...
class PodSpec(BaseModel):
    ...
    overhead: dict[str, str | float] | None = Field(
        default=None,
