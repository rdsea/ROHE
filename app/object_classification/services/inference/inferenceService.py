...
from app.object_classification.modules.common import InferenceEnsembleState, MongoDBInfo
from app.object_classification.modules.objectClassificationAgent import (
    ObjectClassificationAgent,
)
from app.object_classification.services.inference.inferenceServiceController import (
...
class InferenceService:
    def __init__(
        ...
        controller_endpoint: str = "/inference_service_controller",
    ) -> None:
        # load dependencies
        ...
        MLAgent = ObjectClassificationAgent(
        ...
        quix_producer = QuixStreamProducer(
            kafka_address=config["external_services"]["kafka"]["address"],
