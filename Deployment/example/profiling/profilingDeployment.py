...
def profilingDeploy(host,port, deploy_namespace, testingtime, scales, uconf, key=None):
    ...
    for scale in scales.values():
        ...
        for i in range(node_count):
            ...
            kube_client_core.delete_namespaced_service(name=service_ls[i],namespace=deploy_namespace)
