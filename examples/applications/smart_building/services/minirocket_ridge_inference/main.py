"""MiniRocket + Ridge inference service for activity recognition.

Time-series model using MiniRocket features with Ridge classifier.
...
# Accuracy profile: slightly lower than SVM variant, faster
BASE_CONFIDENCE_RANGE = (0.40, 0.75)
SIMULATED_LATENCY_RANGE_MS = (3, 15)
...
async def predict(request: TimeSeriesRequest) -> dict:
    """Run MiniRocket+Ridge inference on time-series sensor data."""
