...
class ControllerRevision(BaseModel):
    ...
    data: Annotated[
        ...
        Field(None, description="Data is the serialized representation of the state."),
    ]
    kind: Annotated[
        Optional[str],
        Field(
...
class DeploymentSpec(BaseModel):
    ...
    paused: Annotated[
        Optional[bool],
        Field(None, description="Indicates that the deployment is paused."),
    ]
...
class DeploymentList(BaseModel):
    ...
    items: Annotated[
        List[Deployment], Field(description="Items is the list of Deployments.")
    ]
    kind: Annotated[
        Optional[str],
        Field(
    ...
    metadata: Annotated[
        Optional[v1.ListMeta], Field({}, description="Standard list metadata.")
    ]
...
class StatefulSetList(BaseModel):
    ...
    items: Annotated[
        List[StatefulSet], Field(description="Items is the list of stateful sets.")
    ]
    kind: Annotated[
        Optional[str],
        Field(
