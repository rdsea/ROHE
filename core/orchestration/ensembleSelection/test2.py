...
if __name__ == '__main__':
    ...
    parser.add_argument('--nModel', type= int, help='number of selected model', default=4)
    parser.add_argument('--p', type= int, help='Default throughput requirement', default=2)
    parser.add_argument('--exID', type=int, help='experiment id', 
                        default=1)
    ...
    experimentMetaData = {"modelFile":model_path, "deviceFile": device_path, "ensemble": {}, "nModel": nModel, "throughputReq": throughputReq, "runID": runID, "TotalModel": len(models), "TotalDevice": len(devices)}
