...
class Capabilities(BaseModel):
    add: Annotated[Optional[List[str]], Field(None, description="Added capabilities")]
    drop: Annotated[
        Optional[List[str]], Field(None, description="Removed capabilities")
    ]
...
class ConfigMapEnvSource(BaseModel):
    ...
    optional: Annotated[
        Optional[bool],
        Field(None, description="Specify whether the ConfigMap must be defined"),
    ]
...
class ContainerImage(BaseModel):
    ...
    size_bytes: Annotated[
        Optional[int],
        Field(None, alias="sizeBytes", description="The size of the image in bytes."),
    ]
...
class ContainerStateWaiting(BaseModel):
    ...
    reason: Annotated[
        Optional[str],
        Field(None, description="(brief) reason the container is not yet running."),
    ]
...
class EventSource(BaseModel):
    component: Annotated[
        Optional[str],
        Field(None, description="Component from which the event is generated."),
    ]
    host: Annotated[
        Optional[str],
        Field(None, description="Node name on which the event is generated."),
    ]
...
class FCVolumeSource(BaseModel):
    ...
    lun: Annotated[
        Optional[int], Field(None, description="lun is Optional: FC target lun number")
    ]
    read_only: Annotated[
        Optional[bool],
        Field(
...
class HostAlias(BaseModel):
    hostnames: Annotated[
        Optional[List[str]],
        Field(None, description="Hostnames for the above IP address."),
    ]
...
class HostIP(BaseModel):
    ip: Annotated[
        Optional[str],
        Field(None, description="IP is the IP address assigned to the host"),
    ]
...
class PodDNSConfigOption(BaseModel):
    name: Annotated[Optional[str], Field(None, description="Required.")]
...
class PodIP(BaseModel):
    ip: Annotated[
        Optional[str],
        Field(None, description="IP is the IP address assigned to the pod"),
    ]
...
class QuobyteVolumeSource(BaseModel):
    group: Annotated[
        Optional[str],
        Field(None, description="group to map volume access to Default is no group"),
    ]
    read_only: Annotated[
        Optional[bool],
        Field(
...
class SecretEnvSource(BaseModel):
    ...
    optional: Annotated[
        Optional[bool],
        Field(None, description="Specify whether the Secret must be defined"),
    ]
...
class ContainerStateTerminated(BaseModel):
    ...
    signal: Annotated[
        Optional[int],
        Field(None, description="Signal from the last termination of the container"),
    ]
    started_at: Annotated[
        Optional[AwareDatetime],
        Field(
...
class EndpointAddress(BaseModel):
    hostname: Annotated[
        Optional[str], Field(None, description="The Hostname of this endpoint")
    ]
    ip: Annotated[
        str,
        Field(
...
class EndpointSubset(BaseModel):
    ...
    ports: Annotated[
        ...
        Field(None, description="Port numbers available on the related IP addresses."),
    ]
...
class EnvFromSource(BaseModel):
    config_map_ref: Annotated[
        ...
        Field(None, alias="configMapRef", description="The ConfigMap to select from"),
    ]
    prefix: Annotated[
        Optional[str],
        Field(
    ...
    secret_ref: Annotated[
        ...
        Field(None, alias="secretRef", description="The Secret to select from"),
    ]
...
class HTTPGetAction(BaseModel):
    ...
    path: Annotated[
        Optional[str], Field(None, description="Path to access on the HTTP server.")
    ]
    port: Annotated[
        Union[int, str],
        Field(
...
class LimitRangeItem(BaseModel):
    ...
    max: Annotated[
        Optional[Dict[str, Union[str, float]]],
        Field(None, description="Max usage constraints on this kind by resource name."),
    ]
    ...
    min: Annotated[
        Optional[Dict[str, Union[str, float]]],
        Field(None, description="Min usage constraints on this kind by resource name."),
    ]
    type: Annotated[
...
class NodeCondition(BaseModel):
    ...
    reason: Annotated[
        Optional[str],
        Field(None, description="(brief) reason for the condition's last transition."),
    ]
    status: Annotated[
        str, Field(description="Status of the condition, one of True, False, Unknown.")
    ]
...
class NodeRuntimeHandler(BaseModel):
    features: Annotated[
        ...
        Field(None, description="Supported features."),
    ]
    name: Annotated[
        Optional[str],
        Field(
...
class NodeStatus(BaseModel):
    ...
    images: Annotated[
        ...
        Field(None, description="List of container images on this node"),
    ]
    node_info: Annotated[
    ...
    runtime_handlers: Annotated[
        ...
        Field(
            None, alias="runtimeHandlers", description="The available runtime handlers."
        ),
    ]
...
class ReplicationControllerCondition(BaseModel):
    ...
    reason: Annotated[
        Optional[str],
        Field(None, description="The reason for the condition's last transition."),
    ]
    status: Annotated[
        str, Field(description="Status of the condition, one of True, False, Unknown.")
    ]
...
class ServicePort(BaseModel):
    ...
    port: Annotated[
        int, Field(description="The port that will be exposed by this service.")
    ]
    protocol: Annotated[
        Optional[str],
        Field(
...
class Taint(BaseModel):
    ...
    value: Annotated[
        Optional[str],
        Field(None, description="The taint value corresponding to the taint key."),
    ]
...
class ComponentStatus(BaseModel):
    ...
    conditions: Annotated[
        ...
        Field(None, description="List of component conditions observed"),
    ]
    kind: Annotated[
        Optional[str],
        Field(
...
class ComponentStatusList(BaseModel):
    ...
    items: Annotated[
        List[ComponentStatus], Field(description="List of ComponentStatus objects.")
    ]
    kind: Annotated[
        Optional[str],
        Field(
...
class ConfigMapList(BaseModel):
    ...
    items: Annotated[
        List[ConfigMap], Field(description="Items is the list of ConfigMaps.")
    ]
    kind: Annotated[
        Optional[str],
        Field(
...
class ContainerState(BaseModel):
    running: Annotated[
        ...
        Field(None, description="Details about a running container"),
    ]
    terminated: Annotated[
        Optional[ContainerStateTerminated],
        Field(None, description="Details about a terminated container"),
    ]
    waiting: Annotated[
        Optional[ContainerStateWaiting],
        Field(None, description="Details about a waiting container"),
    ]
...
class ContainerStatus(BaseModel):
    ...
    volume_mounts: Annotated[
        ...
        Field(None, alias="volumeMounts", description="Status of volume mounts."),
    ]
...
class DownwardAPIVolumeSource(BaseModel):
    ...
    items: Annotated[
        ...
        Field(None, description="Items is a list of downward API volume file"),
    ]
...
class Event(BaseModel):
    ...
    count: Annotated[
        Optional[int],
        Field(None, description="The number of times this event has occurred."),
    ]
    ...
    related: Annotated[
        Optional[ObjectReference],
        Field(None, description="Optional secondary object for more complex actions."),
    ]
...
class LifecycleHandler(BaseModel):
    exec: Annotated[
        Optional[ExecAction],
        Field(None, description="Exec specifies the action to take."),
    ]
    http_get: Annotated[
...
class NodeSpec(BaseModel):
    ...
    taints: Annotated[
        Optional[List[Taint]],
        Field(None, description="If specified, the node's taints."),
    ]
...
class Probe(BaseModel):
    ...
    grpc: Annotated[
        Optional[GRPCAction],
        Field(None, description="GRPC specifies an action involving a GRPC port."),
    ]
    http_get: Annotated[
        Optional[HTTPGetAction],
        Field(
...
class ServiceStatus(BaseModel):
    conditions: Annotated[
        Optional[List[v1.Condition]], Field(None, description="Current service state")
    ]
...
class DownwardAPIProjection(BaseModel):
    items: Annotated[
        Optional[List[DownwardAPIVolumeFile]],
        Field(None, description="Items is a list of DownwardAPIVolume file"),
    ]
...
class VolumeProjection(BaseModel):
    ...
    secret: Annotated[
        ...
        Field(None, description="secret information about the secret data to project"),
    ]
...
class EphemeralContainer(BaseModel):
    ...
    lifecycle: Annotated[
        Optional[Lifecycle],
        Field(None, description="Lifecycle is not allowed for ephemeral containers."),
    ]
    liveness_probe: Annotated[
        Optional[Probe],
        Field(
    ...
    ports: Annotated[
        Optional[List[ContainerPort]],
        Field(None, description="Ports are not allowed for ephemeral containers."),
    ]
    readiness_probe: Annotated[
        Optional[Probe],
        Field(
...
class ProjectedVolumeSource(BaseModel):
    ...
    sources: Annotated[
        ...
        Field(None, description="sources is the list of volume projections"),
    ]
...
class PodSpec(BaseModel):
    ...
    affinity: Annotated[
        Optional[Affinity],
        Field(None, description="If specified, the pod's scheduling constraints"),
    ]
    automount_service_account_token: Annotated[
        Optional[bool],
        Field(
    ...
    tolerations: Annotated[
        ...
        Field(None, description="If specified, the pod's tolerations."),
    ]
